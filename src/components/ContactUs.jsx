...
const ContactUs = () => {
 ...
 <div>
  {/* Title page */}
  <section className="bg-img1 txt-center p-lr-15 p-tb-92" style={{backgroundImage: 'url("images/bg-01.jpg")', marginTop:"10em"}}>
 ...
 <div className="mapouter"><div className="gmap_canvas">
    <iframe className='w-100' height={400} id="gmap_canvas" src="https://maps.google.com/maps?q=Lahore&t=&z=11&ie=UTF8&iwloc=&output=embed"  />
  </div></div>
  </div>
</div>
